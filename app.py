...
with tab1:
    ...
    client_id = st.text_input("Client ID:", DEFAULT_CLIENT_ID, help="Format: XX-XXXXXXX (e.g., 02-4388252)")
    law_firm_id = st.text_input("Law Firm ID:", DEFAULT_LAW_FIRM_ID, help="Format: XX-XXXXXXX (e.g., 02-1234567)")
